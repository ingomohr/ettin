...
class TestSpecialCharPlusConsumingStrategy {

	private SpecialCharPlusConsumingStrategy objUT;
	...
	void prep() {
		...
		objUT = new SpecialCharPlusConsumingStrategy() {
	...
	void apply() {
		...
		verifyNoInteractions(currentTransitionSource);
